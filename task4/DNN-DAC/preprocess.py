...
saved_path = 'task4/DNN-DAC/THUCNews/data'
...
def make_data(samples, path):
    ...
    for pid, sample in samples.items():
        for sent in sample:
            ...
            act = sent['dialogue_act']
            if not act:
                act = 'Other'
            
            if act not in tag2id:
                print(f"Warning: Unknown tag '{act}', mapping to 'Other'")
                act = 'Other'
